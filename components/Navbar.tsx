...
const megaCategories: MegaCategory[] = [
  {
    ...
    links: [
      ...
      { label: "Cardiac Care", href: "/departments" },
      { label: "Surgical Care", href: "/departments" },
      { label: "Women's Health", href: "/departments" },
      { label: "Child Health", href: "/departments" },
      { label: "Neuro Care", href: "/departments" },
      { label: "Orthopedic Care", href: "/departments" },
      { label: "Emergency Response", href: "/departments" },
      { label: "Rehabilitation", href: "/departments" },
    ],
  },
  {
    id: "super",
    ...
    links: [
      { label: "Advanced Cardiology", href: "/departments" },
      { label: "Neurosciences", href: "/departments" },
      { label: "Uro Sciences", href: "/departments" },
      { label: "Renal Sciences", href: "/departments" },
      { label: "GI Sciences", href: "/departments" },
      { label: "Oncology Services", href: "/departments" },
      { label: "Minimally Invasive Surgery", href: "/departments" },
      { label: "Interventional Procedures", href: "/departments" },
    ],
  },
  {
    id: "broad",
  ...
  },
  {
    ...
    links: [
      { label: "Physiotherapy", href: "/departments" },
      { label: "Diabetes Management", href: "/departments" },
      { label: "Wound Care", href: "/departments" },
      { label: "Foot Care Clinic", href: "/departments" },
      { label: "Breast Care Clinic", href: "/departments" },
      { label: "Vascular Support Clinic", href: "/departments" },
    ],
  },
  {
    id: "diag",
    ...
    links: [
      { label: "Cardiac Diagnostics", href: "/departments" },
      { label: "Endoscopy Diagnostics", href: "/departments" },
      { label: "Interventional Imaging", href: "/departments" },
      { label: "Mammography", href: "/departments" },
      { label: "2D Echo", href: "/departments" },
      { label: "Stress Testing", href: "/departments" },
      { label: "Health Screening", href: "/departments" },
    ],
  },
];
